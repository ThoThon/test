...
extension SelectStaffWidget on SelectStaffPage {
  ...
  Widget _buildItemStaff(SelectStaffResponse item) {
    return Obx(() {
      ...
      return InkWell(
        onTap: () => controller.staffSelected.value = item,
        child: Row(
          ...
          children: [
            ...
            sdsSBWidth12,
            Expanded(child: _buildStaffInfo(item)),
            Icon(
    ...
    return Column(
      ...
      children: [
        RichText(
          text: TextSpan(
            children: [
              TextSpan(text: item.hoTen, style: AppTextStyle.font16Bo),
        ...
        if (item.chucVu.isNotEmpty)
          SDSBuildText(item.chucVu, style: AppTextStyle.font12Re),
      ],
    );
  }
      ...
      child: UtilWidget.buildCardBase(
        baseShowLoading(
          () => UtilWidget.buildSmartRefresher(
            ...
            enablePullUp: true,
            child: Obx(
              () => controller.listStaffSelect.isEmpty
  ...
  Widget _buildButtonConfirm() {
    return UtilWidget.buildSolidButton(
      ...
      onPressed: () => Get.back(result: controller.staffSelected.value),
