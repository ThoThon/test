...
class SaveXmlResult630cUseCase extends UseCase<String, SaveXmlResultCl> {
  final OtherInfoRepository _otherInfoRepository;

  SaveXmlResult630cUseCase(this._otherInfoRepository);

  @override
  Future<SaveXmlResultCl> execute(String input) {
    return _otherInfoRepository.saveXml630c(declarationPeriodId: input);
  }
}
