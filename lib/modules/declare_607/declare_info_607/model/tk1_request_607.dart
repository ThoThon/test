...
class Tk1Request607 {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'nhanBanGiayTinhId': nhanBanGiayTinhId,
      'nhanBanGiayHuyenId': nhanBanGiayHuyenId,
      'nhanBanGiayXaId': nhanBanGiayXaId,
  ...
  static Tk1Request607 fromState({
    ...
    return Tk1Request607(
      ...
      khaiSinhHuyenId: null, // Do do đã bỏ huyện
      ...
      noiNhanHuyenId: null, // Do do đã bỏ huyện
      ...
      nhanBanGiayHuyenId: null, // Do do đã bỏ huyện
      ...
      chuHoThuongTruHuyenId: null, // Do do đã bỏ huyện
