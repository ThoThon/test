              ...
              funcSelect: (didChange) {
                nav.bottomSheet(
                  BottomSheetSearch<Ethnic>(
                    ...
                    listFilter: AppData.instance.ethnicsCl.toList(),
              ...
              funcSelect: (didChange) {
                nav.bottomSheet(
                  BottomSheetSearch<Nation>(
                    ...
                    listFilter: AppData.instance.nationsCl.toList(),
              ...
              funcSelect: (didChange) {
                nav.bottomSheet(
                  BottomSheetSearch<Province>(
                    ...
                    listFilter: AppData.instance.provincesCl.toList(),
              ...
              funcSelect: (didChange) {
                nav.bottomSheet(
                  BottomSheetSearch<Relationship>(
                    ...
                    listFilter: AppData.instance.relationshipsCl.toList(),
