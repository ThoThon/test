...
class GetViewPdf630bUseCase extends UseCase<GetPreviewPdfRequestCl, String> {
  final DeclarationListRepositoryCl _declarationListRepositoryCl;
  GetViewPdf630bUseCase(this._declarationListRepositoryCl);

  @override
  Future<String> execute(GetPreviewPdfRequestCl input) {
    return _declarationListRepositoryCl.getPreviewPdf630b(request: input);
  }
}
