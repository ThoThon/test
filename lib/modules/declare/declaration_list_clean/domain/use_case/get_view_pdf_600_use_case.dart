...
class GetViewPdf600UseCase extends UseCase<GetPreviewPdfRequestCl, String> {
  final DeclarationListRepositoryCl _declarationListRepositoryCl;
  GetViewPdf600UseCase(this._declarationListRepositoryCl);

  @override
  Future<String> execute(GetPreviewPdfRequestCl input) {
    return _declarationListRepositoryCl.getPreviewPdf(request: input);
  }
}
