...
class LocaleKeys {
  ...
  static const declaration_declarationSocial = 'declaration_declarationSocial';
  static const declaration_selectedUnitCode = 'declaration_selectedUnitCode';
  static const declaration_selectTaxCode = 'declaration_selectTaxCode';
  static const declaration_declarationListCode =
      'declaration_declarationListCode';
  ...
  static const certificate_serial = 'certificate_serial';
  static const certificate_startFormDate = 'certificate_startFormDate';
  static const certificate_to = 'certificate_to';
  static const certificate_subjectName = 'certificate_subjectName';
  static const certificate_declarationTaxCode =
      'certificate_declarationTaxCode';
  static const certificate_taxCodeInValid = 'certificate_taxCodeInValid';
  static const certificate_validTo = 'certificate_validTo';
  static const certificate_validForm = 'certificate_validForm';
  static const certificate_packageName = 'certificate_packageName';
  static const certificate_email = 'certificate_email';
  static const certificate_phone = 'certificate_phone';
  static const certificate_organization = 'certificate_organization';
  static const certificate_certHint = 'certificate_certHint';
  static const certificate_active = 'certificate_active';
  static const certificate_inActive = 'certificate_inActive';
  static const certificate_activeNow = 'certificate_activeNow';
  static const certificate_activeCert = 'certificate_activeCert';
  static const certificate_verifySuccessfully =
      'certificate_verifySuccessfully';
  static const certificate_confirmActive = 'certificate_confirmActive';
  static const awaitConfirmSign_confirm = 'awaitConfirmSign_confirm';
  static const awaitConfirmSign_checkConfirmSign =
      'awaitConfirmSign_checkConfirmSign';
  static const awaitConfirmSign_checkListSign =
      'awaitConfirmSign_checkListSign';
  static const awaitConfirmSign_waitActive = 'awaitConfirmSign_waitActive';
  static const awaitConfirmSign_createDate = 'awaitConfirmSign_createDate';
  static const awaitConfirmSign_activeCode = 'awaitConfirmSign_activeCode';
  static const awaitConfirmSign_inputPinCode = 'awaitConfirmSign_inputPinCode';
  static const awaitConfirmSign_pleaseInputPinCode =
      'awaitConfirmSign_pleaseInputPinCode';
  static const awaitConfirmSign_comfirmSignSuccessfully =
  ...
  static const registerCode_downloadAttachment =
      'registerCode_downloadAttachment';
  ...
  static const registerCode_continue = 'registerCode_continue';
  static const registerCode_back = 'registerCode_back';
  static const registerCode_register = 'registerCode_register';
  static const registerCode_taxCodeCannotEmpty =
      'registerCode_taxCodeCannotEmpty';
  static const registerCode_unitCodeCannotEmpty =
      'registerCode_unitCodeCannotEmpty';
  static const registerCode_unitNameCannotEmpty =
      'registerCode_unitNameCannotEmpty';
  static const registerCode_unitTypeCannotEmpty =
      'registerCode_unitTypeCannotEmpty';
  static const registerCode_productIndustryCannotEmpty =
      'registerCode_productIndustryCannotEmpty';
  static const registerCode_decisionNumberCannotEmpty =
      'registerCode_decisionNumberCannotEmpty';
  static const registerCode_addressDecisionCannotEmpty =
      'registerCode_addressDecisionCannotEmpty';
  static const registerCode_addressRegisterBusinessCannotEmpty =
      'registerCode_addressRegisterBusinessCannotEmpty';
  static const registerCode_addressUnitCannotEmpty =
      'registerCode_addressUnitCannotEmpty';
  static const registerCode_contactInfoCannotEmpty =
      'registerCode_contactInfoCannotEmpty';
  static const registerCode_phoneUnitCannotEmpty =
      'registerCode_phoneUnitCannotEmpty';
  static const registerCode_emailUnitCannotEmpty =
      'registerCode_emailUnitCannotEmpty';
  static const registerCode_personTransactionSocialCannotEmpty =
      'registerCode_personTransactionSocialCannotEmpty';
  static const registerCode_phoneContactCannotEmpty =
      'registerCode_phoneContactCannotEmpty';
  static const registerCode_selectSocialAgencyCannotEmpty =
      'registerCode_selectSocialAgencyCannotEmpty';
  static const registerCode_selectDistrictReceiveCannotEmpty =
      'registerCode_selectDistrictReceiveCannotEmpty';
  static const registerCode_registerResultCannotEmpty =
      'registerCode_registerResultCannotEmpty';
  static const registerCode_otherInfoCannotEmpty =
      'registerCode_otherInfoCannotEmpty';
  static const registerCode_methodReceiveResultCannotEmpty =
      'registerCode_methodReceiveResultCannotEmpty';
  static const registerCode_methodPaymentCannotEmpty =
      'registerCode_methodPaymentCannotEmpty';
  static const registerCode_fileIncludeCannotEmpty =
      'registerCode_fileIncludeCannotEmpty';
  static const registerCode_contentCannotEmpty =
      'registerCode_contentCannotEmpty';
...
class Locales {
  ...
  static const vi_VN = {
    ...
    'input_textEmpty': '-',
    'declaration_declarationSocial': 'Kê khai BHXH',
    'declaration_selectedUnitCode': 'Chọn mã đơn vị',
    'declaration_selectTaxCode': 'Chọn mã số thuế',
    'declaration_declarationListCode': 'Danh sách mã đơn vị',
    ...
    'certificate_startFormDate': 'Có hiệu lực từ ',
    'certificate_to': 'đến',
    'certificate_subjectName': 'Tên chủ thể',
    'certificate_declarationTaxCode': 'Mã số thuế/CCCD',
    'certificate_taxCodeInValid':
        'Mã số thuế/CCCD không khớp với thông tin đăng ký sử dụng dịch vụ',
    'certificate_validTo': 'Ngày hết hạn',
    'certificate_validForm': 'Ngày hiệu lực',
    'certificate_packageName': 'Thông tin gói',
    'certificate_email': 'Email',
    'certificate_phone': 'SĐT',
    'certificate_organization': 'Nhà cung cấp',
    'certificate_certHint':
        'Lưu ý: Trường hợp sai thông tin trong chứng thư số vui lòng liên hệ tổng đài hỗ trợ 19003369',
    'certificate_active': 'Đang hoạt động',
    'certificate_inActive': 'Chưa kích hoạt',
    'certificate_activeNow': 'Kích hoạt ngay',
    'certificate_activeCert': 'Kích hoạt chứng thư số',
    'certificate_verifySuccessfully': 'Kích hoạt thành công!',
    'certificate_confirmActive': 'Xác nhận kích hoạt',
    'awaitConfirmSign_confirm': 'Xác nhận',
    'awaitConfirmSign_checkConfirmSign': 'Bạn có yêu cầu ký số cần xác thực',
    'awaitConfirmSign_checkListSign': 'Kiểm tra',
    'awaitConfirmSign_waitActive': 'Chờ kích hoạt',
    'awaitConfirmSign_createDate': 'Ngày tạo',
    'awaitConfirmSign_activeCode': 'Mã kích hoạt',
    'awaitConfirmSign_inputPinCode': 'Nhập mã PIN',
    'awaitConfirmSign_pleaseInputPinCode':
        'Vui lòng nhập mã PIN để xác thực hồ sơ',
    ...
    'declareInfo_countDayInvalid': 'Tổng số ngày nhập không hợp lệ',
    'declareInfo_countDayHint': 'Nhập tổng số ngày (VD: 10 hoặc 10,5)',
    ...
    'registerCode_downloadAttachment': 'Tải tệp đính kèm',
    ...
    'registerCode_continue': 'Tiếp tục',
    'registerCode_back': 'Quay lại',
    'registerCode_register': 'Đăng ký',
    'registerCode_taxCodeCannotEmpty': 'Mã số thuế không được để trống',
    'registerCode_unitCodeCannotEmpty': 'Mã đơn vị không được để trống',
    'registerCode_unitNameCannotEmpty': 'Tên đơn vị không được để trống',
    'registerCode_unitTypeCannotEmpty': 'Loại hình đơn vị không được để trống',
    'registerCode_productIndustryCannotEmpty':
        'Ngành nghề sản xuất không được để trống',
    'registerCode_decisionNumberCannotEmpty':
        'Số quyết định không được để trống',
    'registerCode_addressDecisionCannotEmpty':
        'Nơi cấp quyết định không được để trống',
    'registerCode_addressRegisterBusinessCannotEmpty':
        'Địa chỉ đăng ký kinh doanh không được để trống',
    'registerCode_addressUnitCannotEmpty': 'Địa chỉ đơn vị không được để trống',
    'registerCode_contactInfoCannotEmpty':
        'Thông tin liên hệ không được để trống',
    'registerCode_phoneUnitCannotEmpty':
        'Điện thoại đơn vị không được để trống',
    'registerCode_emailUnitCannotEmpty': 'Email đơn vị không được để trống',
    'registerCode_personTransactionSocialCannotEmpty':
        'Người giao dịch BHXH không được để trống',
    'registerCode_phoneContactCannotEmpty':
        'Điện thoại liên hệ không được để trống',
    'registerCode_selectSocialAgencyCannotEmpty':
        'Chọn cơ quan BHXH không được để trống',
    'registerCode_selectDistrictReceiveCannotEmpty':
        'Chọn nơi nhận huyện không được để trống',
    'registerCode_registerResultCannotEmpty':
        'Đăng ký nhận kết quả không được để trống',
    'registerCode_otherInfoCannotEmpty': 'Thông tin khác không được để trống',
    'registerCode_methodReceiveResultCannotEmpty':
        'Phương thức nhận kết quả không được để trống',
    'registerCode_methodPaymentCannotEmpty':
        'Phương thức đóng không được để trống',
    'registerCode_fileIncludeCannotEmpty': 'Hồ sơ kèm theo không được để trống',
