...
import '../../../modules/declare/declare_info/model/gender.dart';
...
class StaffFamilyResponseDataMapper
  ...
  StaffFamilyResponseCl mapToEntity(StaffFamilyResponseDataCl? data) {
    return StaffFamilyResponseCl(
      ...
      gender: Gender.parse(data?.gioiTinh) ?? Gender.female,
      ...
      onlyYearOfBirth:
          BirthTypeEnum.parse(data?.chiCoNamSinh) ?? BirthTypeEnum.defaultValue,
