...
class SelectedStaffDetailDataMapper
  ...
  SelectedStaffDetail mapToEntity(SelectedStaffDetailData? data) {
    return SelectedStaffDetail(
      ...
      baseSalaryCoefficient: data?.heSoLuongCoBan,
      salary: data?.tienLuong,
      positionAllowance: data?.phuCapChucVu,
      seniorityBeyondFrameAllowance: data?.phuCapThamNienVuotKhung,
      seniorityAllowance: data?.phuCapThamNienNghe,
      salaryAllowance: data?.phuCapLuong,
      additionalAllowance: data?.phuCapBoSung,
