// NOTE: DropdownButtonFormField đang có lỗi padding khi dùng kèm với ButtonTheme
            ...
            return Focus(
              ...
              child: Builder(builder: (BuildContext context) {
                ...
                late final InputBorder? resolvedBorder = switch ((
                  ...
                  (enabled: _, focused: true, error: true) =>
                    effectiveDecoration.focusedErrorBorder,
                  (enabled: _, focused: _, error: true) =>
                    effectiveDecoration.errorBorder,
                  (enabled: _, focused: true, error: _) =>
                    effectiveDecoration.focusedBorder,
                  (enabled: true, focused: _, error: _) =>
                    effectiveDecoration.enabledBorder,
                  (enabled: false, focused: _, error: _) =>
                ...
                return DropdownButtonHideUnderline(
                  child: DropdownButton<T>._formField(
                    ...
                    inputDecoration: effectiveDecoration.copyWith(
                      ...
                      hintText:
                          effectiveDecoration.hintText != null ? '' : null,
                    ),
                    isEmpty: isEmpty,
                    isFocused: isFocused,
                    padding: padding,
